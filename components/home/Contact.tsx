...
function Contact() {
  return (
    <Box id="contact" className="body-font relative">
      <Flex className="mb-20 w-full flex-col text-center ">
        <Heading as="h1" className="title-font mb-4 text-2xl font-medium">
          Contact Us
        </Heading>
        <Text className="mx-auto text-base leading-relaxed lg:w-2/3">
          Feel free to reach out to us with any enquiries.
        </Text>
      </Flex>
      <Flex className="container mx-auto flex-wrap px-5 pb-10 sm:flex-nowrap">
          ...
          <div className="relative flex flex-wrap rounded bg-gray-900 py-6 shadow-md">
            ...
            <div className="mt-4 px-6 lg:mt-0 lg:w-1/2">
              ...
              <a
                ...
                className="leading-relaxed text-blue-400"
              >
                ada@ymfltd.com
              </a>
